"""husainabubakar URL Configuration
...
urlpatterns = [
    ...
    path('69a9ab6c74950c387c76877bd9e5da2e9af3ce6741dd3f47908e648eaba865d2/', admin.site.urls),
    ...
    path('contact_me/', a_views.contactMe, name='contact_me'),
